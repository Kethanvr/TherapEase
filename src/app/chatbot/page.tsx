            ...
            {navigationItems.map((item, idx) => {
              ...
              return (
                <div key={item.id}>
                  ...
                  {/* Insert About Creator link after Medication */}
                  {item.id === "medication" && (
                    <button
                      onClick={() => (window.location.href = "/about")}
                      className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left transition-all duration-200 text-gray-700 hover:bg-gray-50 font-medium`}
                    >
                      <svg
